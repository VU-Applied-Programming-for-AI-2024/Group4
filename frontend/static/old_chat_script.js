...
// Connect html code to this script
const chatBox = 
...
//swithing from light to dark mode
modeToggle.addEventListener('change', () => {
    document.body.classList.toggle('dark-mode');
});

//checking if user sends message
...
// sensing when user clicks buttons
document.addEventListener('DOMContentLoaded', function () {
    ...
    //code to make sidebar go in and out
    ...
    //code to start new conversation
...
// function that generates chat's response
function getResponse(message) {
    ...
    setTimeout(() => appendMessage('Bartender', response), 1000);
}
